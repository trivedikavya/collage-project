this.workbox = this.workbox || {}, this.workbox.core = function(e) {
    ...
    const c = e => new URL(String(e), location.href).href.replace(new RegExp("^" + location.origin), ""),
        ...
        l = async ({
            ...
            let r = e;
            for (const e of s) r = await e.cacheKeyWillBeUsed.call(e, {
                mode: t,
                request: r
        ...
        h = {
            put: async ({
                ...
                for (const t of d) await t.cacheDidUpdate.call(t, {
                    cacheName: e,
                    event: r,
                    oldResponse: g,
                    newResponse: w,
    ...
    for (const [e, t] of Object.entries(y))
        for (const n of t) n in IDBObjectStore.prototype && (g.prototype[n] = async function(t, ...s) {
    ...
    var v = Object.freeze({
        ...
        resultingClientExists: async function(e) {
            ...
            for (; performance.now() - r < 2e3 && (t = await self.clients.matchAll({
                    type: "window"
                }), s = t.find(t => e ? t.id === e : !n.has(t.id)), !s);) await q(100);
            return s
        },
        timeout: q,
        WorkboxError: n
    ...
    return e._private = v, e.cacheNames = x, e.clientsClaim = function() {
